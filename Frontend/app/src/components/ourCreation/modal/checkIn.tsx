...
interface ModalSubscribeActivityProps {
  ...
  CodeCheckIn?: ReactNode;
}

function ModalCheckInActivity({
  ActionButton,
  AprovedParticipants,
        ...
        <AlertDialogContent className="w-[848px] h-[752px] flex flex-col">
          <div className="w-full flex gap-x-12 ">
            <div className="space-y-10 w-1/2">
              ...
              <div className="h-21.5 w-full space-y-1.5">
            ...
            <div className="w-1/2 space-y-10">
              ...
              <div className="space-y-2">
                ...
                <div className="overflow-auto max-h-75 space-y-2 font-semibold text-[16px] leading-5 text-[#404040]">
