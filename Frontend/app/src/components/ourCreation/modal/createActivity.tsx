        ...
        <AlertDialogContent className="w-[784px] h-[770px] ">
          ...
          <Form {...form}>
            ...
            >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="space-y-1.5">
                        ...
                        <FormControl>
                          <Input className="h-14 placeholder:text-[#A1A1A1] placeholder:text-base placeholder:leading-6" {...field} placeholder="Ex.: Aula de Ioga"/>
                        </FormControl>
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="space-y-1.5">
                        ...
                        <FormControl>
                          <Textarea className="h-27.5 placeholder:text-[#A1A1A1] placeholder:text-base placeholder:leading-6" {...field} placeholder="Como será a atividade? Quais as regras? O que é necessário para participar?"/>
                        </FormControl>
                      </FormItem>
                    )}
                  ></FormField>
              ...
              <div className="mt-4 h-12 flex justify-end">
                <Button
                  className="w-56  bg-emerald-500 font-bold text-[16px] leading-6 "
                  size="lg"
                >
                  Criar
                </Button>
